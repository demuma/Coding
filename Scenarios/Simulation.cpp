...
void Simulation::update(float deltaTime) {
    ...
    for (auto agent = agents.begin(); agent != agents.end(); ) {
        ...
        //         agent->getFuturePositionAtTime(deltaTime).x - agent->bufferRadius,
        //         agent->getFuturePositionAtTime(deltaTime).y - agent->bufferRadius,
        ...
        predictCollisionObstacle(*agent, obstacles);
